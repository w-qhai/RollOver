$managedDatablockSet = new SimSet() {
   ...
   new t2dImageMapDatablock(night_bdImageMap) {
      imageName = "~/data/images/night_bd.jpg";
      imageMode = "FULL";
      frameCount = "-1";
      filterMode = "SMOOTH";
      filterPad = "1";
   ...
   new t2dImageMapDatablock(JalapenoCardImageMap1) {
   ...
   new t2dImageMapDatablock(GameOverImageMap) {
      imageName = "~/data/images/static/GameOver.png";
      imageMode = "FULL";
      frameCount = "-1";
      filterMode = "SMOOTH";
      filterPad = "1";
